...
/**
 * PWWEB\Core\Database\Seeders\Currency Seeder.
 *
...
class CurrencySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $currencies[] = ['name' => 'Chinese Yuan Renminbi', 'iso' => 'CNY', 'numeric_code' => '156', 'active' => '0', 'entity_code' => '¥', 'standard' => '0'];
        ...
        $currencies[] = ['name' => 'Hungarian Forint', 'iso' => 'HUF', 'numeric_code' => '348', 'active' => '0', 'entity_code' => 'Ft', 'standard' => '0'];
        $currencies[] = ['name' => 'Indonesian Rupiah', 'iso' => 'IDR', 'numeric_code' => '360', 'active' => '0', 'entity_code' => 'Rp', 'standard' => '0'];
        $currencies[] = ['name' => 'Israeli Sheqel', 'iso' => 'ILS', 'numeric_code' => '376', 'active' => '0', 'entity_code' => '₪', 'standard' => '0'];
        $currencies[] = ['name' => 'Indian Rupee', 'iso' => 'INR', 'numeric_code' => '356', 'active' => '0', 'entity_code' => '₹', 'standard' => '0'];
        $currencies[] = ['name' => 'Icelandic Krona', 'iso' => 'ISK', 'numeric_code' => '352', 'active' => '0', 'entity_code' => 'kr', 'standard' => '0'];
        $currencies[] = ['name' => 'Japenese Yen', 'iso' => 'JPY', 'numeric_code' => '392', 'active' => '0', 'entity_code' => '¥', 'standard' => '0'];
        $currencies[] = ['name' => 'South Korean Won', 'iso' => 'KRW', 'numeric_code' => '410', 'active' => '0', 'entity_code' => '₩', 'standard' => '0'];
        ...
        $currencies[] = ['name' => 'Polish Zloty', 'iso' => 'PLN', 'numeric_code' => '985', 'active' => '0', 'entity_code' => 'zł', 'standard' => '0'];
        $currencies[] = ['name' => 'Romanian Leu', 'iso' => 'RON', 'numeric_code' => '946', 'active' => '0', 'entity_code' => 'leu', 'standard' => '0'];
        ...
        $currencies[] = ['name' => 'Thai Baht', 'iso' => 'THB', 'numeric_code' => '764', 'active' => '0', 'entity_code' => '฿', 'standard' => '0'];
        ...
        $currencies[] = ['name' => 'South African Rand', 'iso' => 'ZAR', 'numeric_code' => '710', 'active' => '0', 'entity_code' => 'R', 'standard' => '0'];
