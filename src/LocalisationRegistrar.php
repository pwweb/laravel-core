...
use PWWEB\Core\Contracts\Country as CountryContract;
...
class LocalisationRegistrar
{
    ...
    {
        $this->addressClass = config('pwweb.core.models.address');
        $this->addressTypeClass = config('pwweb.core.models.address_type');
        $this->countryClass = config('pwweb.core.models.country');
        $this->currencyClass = config('pwweb.core.models.currency');
        $this->languageClass = config('pwweb.core.models.language');
    ...
    {
        self::$cacheExpirationTime = config('pwweb.core.cache.expiration_time', config('pwweb.core.cache_expiration_time'));

        self::$cacheKey = config('pwweb.core.cache.key');
        self::$cacheModelKey = config('pwweb.core.cache.model_key');
    ...
    protected function getCacheStoreFromConfig(): Repository
    {
        ...
        $cacheDriver = config('pwweb.core.cache.store', 'default');
     ...
     *
     * @return \PWWEB\Core\Contracts\Address|null
     */
     ...
     *
     * @return \PWWEB\Core\Contracts\Address\Type|null
     */
     ...
     *
     * @return \PWWEB\Core\Contracts\Country|null
     */
     ...
     *
     * @return \PWWEB\Core\Contracts\Currency|null
     */
     ...
     *
     * @return \PWWEB\Core\Contracts\Language|null
     */
